    ...
    public void showIfNeeded() {
        if (!preferences.getTacAccepted() && !BitsquareApp.DEV_MODE) {
            ...
            String text = "1. This software is experimental and provided \"as is\", without warranty of any kind, " +
                    ...
                    "2. The user is responsible to use the software in compliance with local laws. Don't use Bitsquare if the usage of Blackcoin is not legal in your jurisdiction.\n\n" +
                    "3. Blackcoin market price is delivered by 3rd parties (BitcoinAverage, Poloniex). It is your responsibility to double check the price with other sources.\n\n" +
                    ...
                    "    - If the bank of the fiat sender charges fees the sender (blackcoin buyer) has to cover the fees.\n" +
